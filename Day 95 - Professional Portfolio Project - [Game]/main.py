...
screen.tracer(0)
screen.addshape(f"{os.getcwd()}/Day 95 - Professional Portfolio Project - [Game]/aliennew.gif")
screen.addshape(f"{os.getcwd()}/Day 95 - Professional Portfolio Project - [Game]/spaceship.gif")
