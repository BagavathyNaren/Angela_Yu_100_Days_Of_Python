...
response = requests.post(exercise_endpoint, verify=False,json=parameters, headers=headers)
...
if not sheet_endpoint:
    raise ValueError("ENV_SHEETY_ENDPOINT environment variable is not set.")
...
sheet_endpoint = f"https://api.sheety.co/{SHEETY_USERNAME}/{PROJECT_NAME}/{SHEET_NAME}"
