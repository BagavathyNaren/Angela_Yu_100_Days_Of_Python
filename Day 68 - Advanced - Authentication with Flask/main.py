...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///H:/100_Days_Of_Python_Coding_Angela_Yu/Day 68 - Advanced - Authentication with Flask/instance/users.db'
...
return send_from_directory('static', path="H:/100_Days_Of_Python_Coding_Angela_Yu/Day 68 - Advanced - Authentication with Flask/static/files/cheat_sheet.pdf")
