...
class DataManager:
    ...
    def get_destination_data(self):
        ...
        response = requests.get(url=self.prices_endpoint, verify=False, auth=self._authorization)
        data = response.json()
    ...
    def get_customer_emails(self):
        response = requests.get(url=self.users_endpoint, verify=False,auth=self._authorization)
        data = response.json()
